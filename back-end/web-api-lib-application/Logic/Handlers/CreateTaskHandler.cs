...
{
    public class CreateTaskHandler : IRequestHandler<CreateTaskCommand, Permission>
    {
        ...
        public async Task<Permission> Handle(CreateTaskCommand request, CancellationToken cancellationToken)
        {
